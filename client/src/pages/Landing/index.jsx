    ...
    return (
        <div className="landing-container">
            <div className="search-create-wrapper">
                <input className="search-bar" id="search-box" value={searchName} onChange={filterBySearch}
                       placeholder="Search by name, cuisine, or ingredient..."/>
                <button className="create-recipe-btn" onClick={openModal}>Create a Recipe</button>
            </div>
            {isModalOpen && (
